...
### Usage Instructions
To play the demo, simply download either of the executables in the demos folder, then follow the instructions on screen. 
To make changes to the version of the game dedicated to naming conventions, set the folder labeled Code (Naming Convention Version) as the project folder when importing into Godot. This is the version that the demo was created from. 
To make your own version of the game using a blank copy of the game with no existing content, set the folder labeled Code (Blank Version)

### Implementation Overview
This project was implemented in Godot using GDScript.
